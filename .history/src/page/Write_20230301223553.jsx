  ...
  return (
    <div className="mt-10 px-5 container mx-auto flex flex-wrap justify-around ">
      ...
      <div className="flex flex-col flex-wrap">
        <div className="m-10 md:mt-0 lg:mt-10">
          <div className="flex flex-col pt-5 px-7 pb-5 gap-0 text-start border-2 border-gray-200">
        ...
        <div className="xl:mt-3 lg:mt-3 mx-14 md:mx-0 flex flex-col pt-5 px-7 pb-5 gap-2 text-start border-2 border-gray-200">
