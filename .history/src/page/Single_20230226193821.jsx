...
export const Single = () => {
  return (
    <div className="py-10 container mx-auto flex flex-wrap justify-between">
      <div className="container w-3/4">
        <div className="w-full h-80">
          <img
            ...
            src="https://www.latercera.com/resizer/TUoVffyqFeo1u8zX8GbrqYCdpiI=/arc-anglerfish-arc2-prod-copesa/public/GGFC2WPKSBAA7I7NACR7RKQLRU.jpg"
          />
        </div>
      ...
      <div className="mr-10 ml-10 sm:ml-2 lg:ml-2 pt-2">
        <h1 className="font-bold text-xl">Other posts you may like</h1>
        {posts.map(post=> (
          <div key={post.key} className="w-full lg:w-72 py-5">
            <img src={post.img} className="object-cover w-full h-full" />
            <h3 className="text-start text-2xl font-bold">{post.title}</h3>
            <button className="float-left my-5 border-x-blue-500 bg-transparent text-blue-600">Read more</button>
          </div>
        ))}
      </div>
    </div>
