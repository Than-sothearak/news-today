...
export const Footer = () => {
  return (
    <div className="w-full h-46  bg-blue-600 text-white mt-10">
      <div className="flex flex-wrap justify-between container mx-auto p-5 py-10 ">
        <div>
          <h1>Logo</h1>
        </div>
        <div>
        ...
        <div className="flex text-2xl gap-x-4">
          ...
          <a href="https://www.instagram.com/sothearak_z/" className="text-white"><AiFillGithub /></a>
        </div>
      </div>
    </div>
  );
