              ...
              {!editImage ? (
                <div className=" 0">
                  <button
                    ...
                    className="flex justify-end items-center gap-2 hover:text-blue-60"
                  >
                ...
                <div className="flex justify-end items-center gap-2 hover:text-blue-600">
                  ...
                  <button onClick={() => setEditImage((prev) => !prev)}>
                    Close
                  </button>
                </div>
              )}
                ...
                <div>
                  <label className="flex flex-col justify-center items-center border-4 h-60 rounded-md border-dotted cursor-pointer">
                    <div>
                      {uploading && (
                        <button
                          class="flex items-center justify-center space-x-2 gap-2"
                          disabled
                        >
