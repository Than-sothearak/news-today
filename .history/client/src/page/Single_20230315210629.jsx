...
export const Single = () => {
  ...
  return (
    <div className="px-10 container mx-auto flex flex-col justify-center">
      <div className="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
        <Modal 
        show={show} 
        onHide={handleClose}
        className="px-10 container mx-auto flex flex-col justify-center">
          <Modal.Header closeButton className="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full" type="button">
            <Modal.Title>Delete Confirmation</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <div className="alert alert-danger mb-4 text-gray-500 dark:text-gray-300">Do you want to delete?</div>
          </Modal.Body>
          <Modal.Footer>
