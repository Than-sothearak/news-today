      ...
      <div className="lg:w-1/3 flex flex-col flex-wrap p-0">
        ...
        <div className="mt-3 sm:mt-3 md:mt-1.5 lg:mt-4 flex flex-col pt-5 px-7 pb-5 gap-2 text-start border-2 border-gray-200">
          ...
          <div className="flex gap-2">
            <input type="radio"  checked={cat === "art"} value="art" name="category" onChange={(e) => setCat(e.target.value)}/> Art
            <input type="radio"  checked={cat === "technology"} value="technology" name="category" onChange={(e) => setCat(e.target.value)}/> Technology
            <input type="radio"  checked={cat === "design"} value="design" name="category" onChange={(e) => setCat(e.target.value)}/> Design
            <input type="radio"  checked={cat === "food"} value="food" name="category" onChange={(e) => setCat(e.target.value)}/> Food
            <input type="radio"  checked={cat === "videogame"} value="videogame" name="category" onChange={(e) => setCat(e.target.value)}/> Video Game
          </div>
        </div>
      </div>
    </div>
