...
export const Single = () => {
  ...
  return (
    <div className="py-5 container mx-auto">
      ...
      <div className="mt-20 flex flex-warp mx-10 sm:ml-2 md:mx-0 text-start">
        <h1 className="font-bold text-xl">Other posts you may like</h1>
        {posts.map((post) => (
          <div key={post.id} className="w-46 h-full py-5">
            <img src={post.img} className="object-cover w-full h-full" />
            <h3 className="text-start text-xl font-bold">{post.title}</h3>
