...
export const Single = () => {
  ...
  return (
    <div className="py-5 container mx-auto flex flex-col">
      <div className="container mx-auto w-4/5 sm:1/2 md:w-3/5 lg:w-3/5 xl:w-3/4 ml-10 md:ml-5 xl:ml-5">
      ...
      <div className="container mx-auto flex flex-warp gap-5 text-start">
        <h1 className="font-bold text-xl">Other posts you may like</h1>
        {posts.map((post) => (
          <div key={post.id} className="w-46 h-40 py-5">
            <img src={post.img} className="object-cover w-full h-full" />
            <h3 className="text-start text-lg font-bold">{post.title}</h3>
