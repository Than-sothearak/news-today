...
const navigation = [
  ...
  { name: "Portfolio", href: "/?cat=technology", current: false },
                ...
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex space-x-4">
                    ...
                    <Menu as="div" className="relative inline-block text-left">
                      <div>
                        <Menu.Button className="inline-flex w-full justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-semibold text-white hover:bg-gray-50">
                          Blog
                          <ChevronDownIcon
                      ...
                      >
                        <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white focus:outline-none">
                          <div className="py-1">
                            <Menu.Item>
                              {({ active }) => (
                                <a
