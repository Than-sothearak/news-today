...
import { MdClose, MdKeyboardArrowRight, MdModeEdit } from "react-icons/md";
              ...
              >
                <div className="flex flex-col justify-center items-center gap-4 mt-4">
                  ...
                  <img
                    ...
                    alt=""
                  />
                 <button className="absolute right-0 bottom-0 bg-gray-800 rounded-full text-white p-1 hover:bg-slate-600"> <MdModeEdit /></button>
                  
                  </div>
                  <h1 className="text-xl">Welcome, {currentUser.username}!</h1>
                </div>
                <div className="flex justify-center items-center p-2 absolute top-2 right-2 rounded-full hover:bg-slate-200">
