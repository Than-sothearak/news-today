...
export const Navbar = () => {
  ...
  return (
    <nav className="container max-w-full flex justify-between items-center mt-auto bg-white text-black shadow-sm h-full">
      <div className="h-full flex justify-center items-center">
        <h3 className="font-bold text-2xl text-red-600 p-4 w-full">News Today</h3>
      </div>
