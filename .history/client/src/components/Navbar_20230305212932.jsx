        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <li>
              <Link
                to="/profile"
                className="block pl-3 text-white h-10 w-10 rounded-full md:bg-blue-500 md:p-2 md:text-white md:p-0 dark:text-white"
              >
                <p className="text-sm font-sans">{currentUser?.username}</p>
              </Link>
            </li>
            {currentUser ? (
              <div>
                ...
                <li className="float-left ml-3">
                  <Link
                    to="/write"
                    className="block pl-4 text-white bg-white rounded md:bg-blue-500 md:p-2 md:text-white md:p-0 dark:text-white"
                  >
                    Write
                  </Link>
                </li>
