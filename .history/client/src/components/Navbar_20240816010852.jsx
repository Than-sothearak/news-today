    ...
    <div className="relative z-50">
      ...
      {clickedMenu && (
       <>
        ...
        <div className="fixed inset-0 bg-white z-40 md:hidden top-10">
        {currentUser ? (
            <div className="relative group">
              <button
                className="p-6 w-96 flex justify-center"
                onClick={() => setClickProfile((prev) => !prev)}
              >
                {currentUser.username}
              ...
              <div
                className={`shadow-lg absolute w-36  bg-white  flex-col justify-center items-center ${
                  !clickProfile ? "hidden" : "flex"
                }`}
              >
                <Link
