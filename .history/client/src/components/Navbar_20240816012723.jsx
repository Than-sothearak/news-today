        ...
        <div className="mr-6 z-50 border rounded-full md:mt-0 mt-3 bg-blue-800">
          {currentUser ? (
            <div className="relative group">
              ...
              > 
<img class="inline-block h-6 w-6 rounded-full  ring-white" src="https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt=""></img>              </button>
              <div
