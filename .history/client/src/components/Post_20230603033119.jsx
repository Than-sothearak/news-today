...
export const Post = ({ post }) => {
  ...
  // const getMonth = new Date(now_utc).slice(5, 7);
  // const getYear =new Date(now_utc).slice(0, 4);
  // const getDay = new Date(now_utc).slice(8, 10);
      ...
      <Link className="text-gray-700" to={`/post/${post.id}`}>
        ...
        <div className="w-full h-auto text-start mt-2">
          <h2 className="text-sm mb-3">
            {(new Date(now_utc))} {getMonthString(new Date(now_utc))} {new Date(now_utc)}
          </h2>
