        ...
        <div className="fixed inset-0 bg-white z-40 md:hidden flex justify-center items-center">
          ...
          <h3 className="font-bold text-2xl text-red-600 p-5 w-full">
            ...
            {navigation.map((nav) => (
              <div
                key={nav.name}
                className="p-6 text-black hover:bg-red-600 hover:text-white flex justify-center hover:underline"
              >
                ...
                {nav.subCategory && (
                  <div className="flex flex-col justify-center items-start gap-4 hover:underline">
