              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <Menu as="div" className="relative ml-3">
                  ...
                  <Transition
                    ...
                    leaveTo="transform opacity-0 scale-95"
                  >
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md py-1 shadow-lg ring-1 ring-opacity-5 focus:outline-none">
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            href="#"
                ...
                <button className="space-y-1 px-2 pb-3 pt-2">
               <Link
                  to="/login"
                  className=" text-white md:bg-blue-500  dark:text-white"
                >
                  Login
                </Link>
              </button>
