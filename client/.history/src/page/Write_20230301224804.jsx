...
export const Write = () => {
  ...
  return (
    <div className="mt-10 px-5 container mx-auto flex flex-wrap justify-around ">
      <div className=" sm:w-3/5 md:w-2/2 lg:w-3/5 flex flex-col justify-start ">
        <input
      ...
      <div className="flex flex-col flex-wrap p-0">
        <div className="mt-14 md:mt-10 lg:mt-0">
        ...
        <div className="mt-3 sm:mt-3 flex flex-col pt-5 px-7 pb-5 gap-2 text-start border-2 border-gray-200">
