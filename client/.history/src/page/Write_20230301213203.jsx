...
export const Write = () => {
  const category = [{id: 1, title: "art"}, {id: 2, title: "assdsds"}];
      ...
      <div className="flex flex-col flex-wrap">
        ...
        <h1 className="text-3xl font-bold">Category</h1>
         {category.map((category)=> (
           ...
           <input type='radio' name="category" value={category.title} id={category.title} />
           <label htmlFor={category.title}>Art</label>
           </div>
         ))}
